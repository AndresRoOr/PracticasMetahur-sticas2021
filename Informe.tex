...
\begin{document}
	...
	\subsection{Análisis de los resultados}
		...
		\paragraph{}Si analizamos la relación coste-tiempo, la heurística que presenta un mejor comportamiento es la Búsqueda Local, seguida de Greedy, y por ultimo la Búsqueda Tabú.
