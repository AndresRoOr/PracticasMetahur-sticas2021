...
\begin{document}
	...
	\paragraph{}Para realizar la práctica, se ha optado por implementar las
	heurísticas propuestas en el lenguaje de programación \textsc{Java}.
	El ejecutable que se entrega junto a este documento ha sido compilado
	bajo \textsc{ Apache NetBeansIDE 12.0}.
	...
	\subsection{Parámetros de los algoritmos}
		...
		\begin{itemize}
			...
			\item Iteraciones tabú: número máximo de iteraciones a realizar en la búsqueda tabú.
			\item Tenencia tabú: número de iteraciones en la que un elemento tabú permanece en la lista tabú.
			\item Intentos tabú: número de iteraciones máximas sin mejora de la mejor solución.
